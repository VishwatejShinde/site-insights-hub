...
export const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-info/5 rounded-full blur-3xl animate-pulse-glow" style={{ animationDelay: "1s" }} />
              ...
              <div className="relative flex gap-2 p-2 bg-card rounded-xl border border-border">
                <div className="relative flex-1">
                  ...
                  <Input
                    ...
                    className="pl-12 h-14 bg-background border-0 text-lg font-mono input-glow focus-visible:ring-primary"
                ...
                <Button
                  ...
                  size="lg"
                  className="h-14 px-8 bg-gradient-primary hover:opacity-90 text-primary-foreground font-semibold glow-primary"
                >
                  {isAnalyzing ? (
                    <motion.div
                      animate={{ rotate: 360 }}
